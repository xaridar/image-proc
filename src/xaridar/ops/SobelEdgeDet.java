...
public class SobelEdgeDet implements ImageOperation {
    @Override
    ...
    public List<FileInfo> process(List<FileInfo> images, ArgsObj args) throws InterruptedException {
        double[][] lKernel = new double[][]{{1,0,-1},{2,0,-2},{1,0,-1}};
        double[][] rKernel = new double[][]{{-1,0,1},{-2,0,2},{-1,0,1}};
        double[][] tKernel = new double[][]{{1,2,1},{0,0,0},{-1,-2,-1}};
        double[][] bKernel = new double[][]{{-1,-2,-1},{0,0,0},{1,2,1}};
